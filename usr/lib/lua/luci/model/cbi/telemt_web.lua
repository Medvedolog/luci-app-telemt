...
m = Map("telemt", _("Advanced Tuning"),
    _("WEB Proxy settings for Telemt 3.5.7. Configuration is stored only in /etc/config/telemt; the runtime TOML is generated by /etc/init.d/telemt."))

local subnav = m:section(SimpleSection)
